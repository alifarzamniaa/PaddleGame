...
int main()
{
    ...
    Paddle paddle(200.f,20.f,sf::Vector2f(450.f,680.f));
    Ball ball(15.f,{300,400}, sf::Color(160, 21, 62));
    PlayGround playGround("Images/GameOver.png",window,70.f,120.f,sf::Color(131,111,255));
